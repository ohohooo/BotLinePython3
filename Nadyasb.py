...
nadya = LINE()
nadya = LINE("EwCn1U9mk7cqBYPHJMR8.ELwsTiBgq+h2cKrivan/ka.jxKXGgXhR/E5sJeQ6cRmxnm89XvnO3M7G/Hfu3+S7xo=")
#nadya = LINE("Email","Password")
nadya.log("EwCn1U9mk7cqBYPHJMR8.ELwsTiBgq+h2cKrivan/ka.jxKXGgXhR/E5sJeQ6cRmxnm89XvnO3M7G/Hfu3+S7xo=")
...
def helptexttospeech():
    helpTextToSpeech =   "╔══[ คำสั่งพูด ]" + "\n" + \
                         ...
                         "╠ cy : Welsh" + "\n" + \
                         "╚══[ ♻TEAM🔘BOT🔘HARDLINE♻  ]" + "\n" + "\n\n" + \
                          "ตัวอย่าง say-รหัส ตามด้วยคำที่จะพูด"
...
def helptranslate():
    helpTranslate =    "╔══[ คำสั่งแปลภาษา ]" + "\n" + \
                       ...
                       "╠ he : Hebrew" + "\n" + \
                       "╚══[ ♻TEAM🔘BOT🔘HARDLINE♻  ]" + "\n" + "\n\n" + \
                         "ตัวอย่าง tr-รหัส ตามด้วยคำที่จะแปล"
...
#==============================================================================#
                if text.lower() == 'เมนู':
                    ...
                    nadya.sendContact(to, "ufe85023b21166b42486f77897b6bc307")
                elif text.lower() == 'เมนู2':
                    helpTextToSpeech = helptexttospeech()
                    nadya.sendMessage(to, str(helpTextToSpeech))
                elif text.lower() == 'เมนู3':
                    ...
                    if line != None:
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            for ls in lists:
                                ...
                                nadya.sendImageWithURL(msg.to, str(path))
                elif msg.text.lower().startswith("กอปปี้ "):
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
...
#==============================================================================#
                elif msg.text.lower().startswith("ล้อเลียน "):
                    targets = []
                    ...
                    for target in targets:
                        try:
                            ...
                            break
                elif msg.text.lower().startswith("ลบล้อเลียน "):
                    targets = []
                    key = eval(msg.contentMetadata["MENTION"])
                    key["MENTIONEES"][0]["M"]
                    for x in key["MENTIONEES"]:
